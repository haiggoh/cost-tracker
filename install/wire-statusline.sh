...
say ""
say "Optional: export COST_TRACKER_CAP_USD=40 in your shell profile so the segment and the"
say "reports print a denominator. Without it, spend is shown with no cap rather than an"
say "invented one \u2014 the gateway cap is unreadable from here (/key/info returns 403)."
